...
items=[
 ...
 ("나노","250,000 원",[30,65,40,30,50,60],"275"),
 ("KOL 무가시딩","100,000 원",[10,10,10,10,10,10],"60"),
 ("X(트위터) 시딩","500,000 원",[0,5,0,0,5,5],"15"),
 ("__G__","콘텐츠 · 바이럴",None,None),
 ("파워페이지","600,000 원",[0,3,0,0,3,3],"9"),
 ("커뮤니티 체험단","5,000,000 원",[0,1,0,0,1,1],"3"),
 ("네이버 블로그","250,000 원",[0,5,0,0,5,5],"15"),
 ("EGC 콘텐츠","1,500,000 원",[2,2,1,2,1,2],"10"),
 ("__G__","제작",None,None),
 ("KV·디자인·영상","",["●","●","●","●","●","●"],"상시"),
 ("__G__","기타",None,None),
 ("어필리에이트","올영 쇼핑 큐레이터·누적 (명)",[10,20,30,40,50,60],"누적60"),
]
...
for rd in rowdefs:
    ...
    if kind=="PHASE":
        ...
        for i,v in enumerate([55,120,70,55,100,115]): cell_style(tbl.cell(ri,i+1),str(v),11,True,WHITE,BLACK)
        cell_style(tbl.cell(ri,7),"515건",10,True,WHITE,BLACK)
    elif kind=="BUD":
...
q=[
 ...
 ("T","공급가액 소계","262,000,000"),
 ("T","부가가치세 (10%)","26,200,000"),
 ("TT","합계 금액 (VAT 포함)","288,200,000"),
]
nr=len(q)+1
...
for k,n in enumerate([
 "· 프로젝트 대행료 항목 제외, 해당 예산(2,500만)은 크리에이터 나노 시딩에 반영 · EGC 콘텐츠는 건당 1,500,000원 별도 산정",
