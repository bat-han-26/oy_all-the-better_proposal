...
q=[
 ("G","제작비"),
 ("KV·디자인·영상·콘텐츠 제작 (EGC 제외)","1식","-","66,800,000"),
 ...
 ("T","공급가액 소계","249,500,000"),
 ("T","부가가치세 (10%)","24,950,000"),
 ("TT","합계 금액 (VAT 포함)","274,450,000"),
]
nr=len(q)+1
...
for k,n in enumerate([
 "· 대행료 항목 제외(나노 시딩에 반영) · 파워페이지 건당 800,000원(제작비에서 충당) · EGC 건당 1,500,000원 · 공급가액 2.5억 이내",
